    ...
    <div>
      ...
      <div className="flex flex-row flex-wrap content-start">
        {attribute?.values.map((item, i) => {
          // Uncomment out the line below when you are ready to limite options
          if(item.metadata?._thumbnail){
            return (
              <button
                key={i}
                type="button"
              ...
              >
                <div
                  ...
                  style={{ backgroundImage: `url(${item.metadata?._thumbnail})`, backgroundSize: 'cover' }}
